  ...
  if (props.card) {
    return (
      <div className='title-container'>
        <div className='image-container'><img src={"https://res.cloudinary.com/drimvo8rp/image/upload/t_server-logo-full/v1674796880/server-logo/" + props.card.server_uuid + ".png"} alt={props.card.name + ' Logo'}></img></div>
        <div className='text'>
